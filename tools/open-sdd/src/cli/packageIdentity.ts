...
export interface PackageIdentity {
  name: string;
  version: string;
  /** De dónde salió la identidad: la ruta del manifiesto o `fallback`. */
  source: string;
}
 ...
 */
export const readPackageIdentity = (): PackageIdentity => {
...
export const PACKAGE_NAME: string = identity.name;
...
export const PACKAGE_IDENTITY_SOURCE: string = identity.source;
