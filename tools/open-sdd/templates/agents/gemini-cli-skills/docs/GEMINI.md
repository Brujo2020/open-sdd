...
<!-- DEV_GUIDELINES: injected at install time with language-specific guidelines (npx open-sdd@latest --lang <code>) -->
{{DEV_GUIDELINES}}
...
## Skills Structure
Skills are located in `.gemini/skills/sdd-*/SKILL.md`
