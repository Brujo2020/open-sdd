...
- Read `{{SDD_DIR}}/specs/$1/spec.json` for metadata and phase status
- Read `{{SDD_DIR}}/specs/$1/brief.md` if it exists
- Read existing files: `requirements.md`, `design.md`, `tasks.md` (if they exist)
- Check `{{SDD_DIR}}/specs/$1/` directory for available files
...
**Spec Not Found**:
- **Message**: "No spec found for `$1`. Check available specs in `{{SDD_DIR}}/specs/`"
