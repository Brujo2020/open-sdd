...
- `{{SDD_DIR}}/specs/{feature}/spec.json`, `requirements.md`, `design.md` (if exists)
- `{{SDD_DIR}}/specs/{feature}/research.md` (if exists, contains gap analysis from `/sdd-validate-gap`)
...
4. **Persist Findings to Research Log**:
   - Create or update `{{SDD_DIR}}/specs/{feature}/research.md` using the shared template
...
1. **Write Final Design**:
   - Write `{{SDD_DIR}}/specs/{feature}/design.md` only after the design review gate passes
...
1. **Status**: Confirm design document generated at `{{SDD_DIR}}/specs/{feature}/design.md`
...
- **User Message**: "No requirements.md found at `{{SDD_DIR}}/specs/{feature}/requirements.md`"
