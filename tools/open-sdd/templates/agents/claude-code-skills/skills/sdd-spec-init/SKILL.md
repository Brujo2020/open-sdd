...
## Execution Steps
1. **Check for Brief**: If `{{SDD_DIR}}/specs/{feature-name}/brief.md` exists (created by `/sdd-discovery` or `/sdd-getspecs`), read it. The brief contains problem, approach, scope, and constraints from the discovery session. Use this to pre-fill the project description and skip clarification questions that the brief already answers.
