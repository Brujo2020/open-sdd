...
- `{{SDD_DIR}}/specs/$1/spec.json`, `requirements.md`, `design.md` (if exists)
- `{{SDD_DIR}}/specs/$1/research.md` (if exists, contains gap analysis from `$sdd-validate-gap`)
...
4. **Persist Findings to Research Log**:
   - Create or update `{{SDD_DIR}}/specs/$1/research.md` using the shared template
...
1. **Write Final Design and Research Log**:
   - Write `{{SDD_DIR}}/specs/$1/design.md` only after the design review gate passes
...
1. **Status**: Confirm design document generated at `{{SDD_DIR}}/specs/$1/design.md`
