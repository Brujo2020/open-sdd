...
export const parseSharedRules = (content) => {
...
export const buildSharedRuleOperations = async (ruleNames, skillDestDir, templatesRoot, artifactId, cwd, resolved, ctx) => {
    const operations = [];
    ...
    for (const ruleName of ruleNames) {
        ...
        const destAbs = assertPathInsideRoot(path.join(rulesDestDir, ruleName), rulesDestDir, `Shared rule "${ruleName}" destination path`);
