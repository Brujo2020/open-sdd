 ...
 */
export const evaluateGovernanceBudget = (cycleTokens, metrEvalTokens, auditTokens, distillationTokens, ceiling = GOVERNANCE_TOKEN_CEILING) => {
 ...
 */
export const evaluateCompaction = (occupancy, trigger = CONTEXT_COMPACTION_TRIGGER) => {
...
export const METRIC_DEFINITIONS = [
    {
        ...
        definition: 'Fallo detectado DESPUÉS del merge a main cuyo origen se rastrea a un cambio que atravesó la cadena completa.',
    },
    {
 ...
 */
export const compareLoopEconomy = (on, off) => {
 ...
 */
export const routeModel = (tier, candidates) => {
 ...
 */
export const escalateTier = (tier, consecutiveFailures, maxFailures = 3) => {
 ...
 */
export const HARNESS_SELF_FAILURE = [
    {
        kind: 'decidable',
        behavior: 'fail-closed',
        detail: 'Controles decidibles (secretos, comandos destructivos, presencia de evidencia): fallan cerrados y detienen la tubería.',
    },
    {
        kind: 'model-judgment',
        behavior: 'fail-open',
        detail: 'Controles de juicio de modelo: fallan abiertos, registran que no se evaluó y marcan el artefacto como NO AUDITADO.',
    },
];
