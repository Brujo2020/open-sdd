...
export const OWASP_AGENTIC_MAP = [
    {
        ...
        atlas: 'AML.T0051',
        primaryGates: ['G5'],
        complementaryControl: 'Intercepción de comandos destructivos; taint-tracking MCP; separación de la tríada (datos privados + contenido no confiable + canal de egreso).',
    },
    {
...
export const REGULATORY_CONTEXT = 'Las obligaciones de alto riesgo del Reglamento Europeo de IA son exigibles desde el 2 de agosto de 2026; ISO/IEC 42001 se está convirtiendo en requisito de compra; el NIST AI RMF aporta el vocabulario operativo.';
/**
 ...
 */
export const RISK_LAB_BANKS = [
    {
        id: 'bank-1',
        name: 'Centinelas de imposición',
        purpose: 'Lanzar dentro de cada herramienta anfitriona, no contra scripts aislados: un secreto sembrado en un diff, un rm -rf en un comando, una tarea marcada como hecha sin evidencia, una escritura fuera del alcance de la spec.',
    ...
    },
    {
        ...
        purpose: 'Contenido hostil en ficheros, resultados de herramientas y notas de memoria; medir la supervivencia de extremo a extremo hasta una acción privilegiada. Ensaya la cuarentena del inbox con lecciones envenenadas.',
...
export const ZERO_TRUST_BOUNDARY = {
    borrowedExactly: 'Ninguna salida hereda confianza de su origen — ni del agente que la produjo, ni de que acertara en las cinco tareas anteriores, ni de que el gate aprobara ayer — y cada artefacto se evalúa contra política en el momento de presentarse, con la decisión registrada.',
    notClaimed: [
